export default {
  auth: {
    registration: {
      passwordHint: 'Используйте 15–30 символов, заглавные и строчные латинские буквы, цифру и спецсимвол (!@#$%^&*(),.?":{}|<>). Не повторяйте символ более 3 раз подряд.',
      exists: 'Аккаунт с таким email уже существует. Войдите в него.',
      error: 'Не удалось зарегистрироваться. Проверьте данные и попробуйте снова.',
    },
    labels: {
